...
8. **Triển khai hàm **Lambda@Edge**lên CloudFront**: Bạn có thể triển khai hàm **Lambda@Edge**của mình lên CloudFront bằng cách sử dụng AWS CLI.

9. **Metrics and Logs**: **Amazon CloudFront** cung cấp các tính năng giám sát và phân tích hiệu suất của nội dung được phân phối thông qua dịch vụ này. Với việc lưu trữ nhật ký trong S3 và sử dụng các công cụ như Amazon Athena và Amazon Redshift, bạn có thể dễ dàng giám sát và phân tích hiệu suất của nội dung của mình.
...
3. [Tạo CloudFront Distribution](3-create-cloudfront-distribution/)
4. [Kiểm tra Distribution Invalidations](4-distribution-invalidations/)
5. [Cấu hình tùy chỉnh Error Page](5-custom-error-page/)
6. [Cấu hình Origin Group](6-origin-group/)
7. [Các phần tiêu đề phản hồi (Response Headers)](7-response-headers/)
8. [Tạo Cache Behavior](8-cache-behavior/)
9. [Tạo **Lambda@Edge**function](9-lambdaedge-function/)
10. [Triển khai **Lambda@Edge**function đến CloudFront](10-deploy-lambdaedge-function/)
11. [Metric và Logs](11-metrics-and-logs/)
